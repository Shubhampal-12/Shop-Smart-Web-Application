...
export const productImages  = [
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=600&h=750&fit=crop&sat=-100',
    ],
    category: 'Women',
    description: 'A beautifully tailored linen blazer perfect for both casual and formal occasions. Crafted from premium European linen with a relaxed fit.',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    bestseller: true,
    latest: true,
  },
  {
    ...
    category: 'Women',
    description: 'Flowing silk midi dress with an elegant drape. Perfect for evening events or a refined daytime look.',
    sizes: ['XS', 'S', 'M', 'L'],
    bestseller: true,
    latest: true,
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&h=750&fit=crop'],
    category: 'Men',
  ...
  },
  {
    ...
    category: 'Women',
    description: 'Luxuriously soft cashmere sweater in a relaxed crew neck silhouette. Sustainably sourced from Inner Mongolia.',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    latest: true,
  },
  {
    ...
    category: 'Men',
    description: 'Crisp cotton shirt with a structured collar and clean lines. Versatile enough for work or weekend.',
    sizes: ['S', 'M', 'L', 'XL'],
    bestseller: true,
    latest: true,
  },
  {
    ...
    description: 'Hand-stitched leather crossbody bag with adjustable strap. Minimalist design meets everyday functionality.',
    sizes: ['One Size'],
  },
  {
    id: '7',
    ...
    images: ['https://images.unsplash.com/photo-1539533113208-f6df8cc8b543?w=600&h=750&fit=crop'],
    category: 'Women',
    description: 'A statement merino wool coat with a belted waist and oversized lapels. Designed for transitional weather.',
    sizes: ['XS', 'S', 'M', 'L'],
    bestseller: true,
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1576995853123-5a10305d93c0?w=600&h=750&fit=crop'],
    category: 'Men',
    description: 'Classic washed denim jacket with a modern cut. A timeless layering piece for any season.',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    latest: true,
  },
  {
    ...
    price: 65,
    image: 'https://images.unsplash.com/photo-1601924921557-45e8e0e6fba7?w=600&h=750&fit=crop',
    images: ['https://images.unsplash.com/photo-1601924921557-45e8e0e6fba7?w=600&h=750&fit=crop'],
    category: 'Accessories',
    description: 'Vibrant floral print silk scarf. Hand-rolled edges with a luxurious drape.',
    sizes: ['One Size'],
    latest: true,
  },
  {
    ...
    category: 'Men',
    description: 'Comfortable relaxed-fit chinos in organic cotton. Perfect for a smart-casual look.',
    sizes: ['S', 'M', 'L', 'XL'],
  },
  {
    id: '11',
    ...
    category: 'Women',
    description: 'Chunky knit turtleneck in a cozy wool blend. Oversized fit for effortless layering.',
    sizes: ['XS', 'S', 'M', 'L'],
    bestseller: true,
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1544816155-12df9643f363?w=600&h=750&fit=crop'],
    category: 'Accessories',
    description: 'Durable canvas tote with leather handles. Spacious interior with inner pocket.',
    sizes: ['One Size'],
    latest: true,
  },
