...
const Collection = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]'>
      ...
      {/* Category Filter */} 
      <div className={`border border-gray-300  gap-2 p1-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}> 
        <p className='mb-3 text-sm ml-[10px] font-medium'>CATEGORIES</p>
        <div className='flex flex-col ml-[10px] gap-2 tex-sm font-light text-gray-700'>
      ...
      <div className={`border border-gray-300 p1-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}> 
        <p className='mb-3 ml-[10px] text-sm font-medium'>TYPE</p>
        <div className='flex flex-col ml-[10px] gap-2 tex-sm font-ligh text-gray-700'>
          <p className='flex gap-2'>
