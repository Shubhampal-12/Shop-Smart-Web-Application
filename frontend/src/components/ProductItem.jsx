  ...
  return (
    <Link className='block p-3 rounded-[1rem] transition-all duration-300 ease-in-out hover:bg-gray-400 hover:scale-105 cursor-pointer' to={id ? `/product/${id}` : '#'}>
      <div className='overflow-hidden'>
        <img className='w-full transition-transform duration-300 ease-in-out hover:scale-110 hover:w-[105%] hover:h-[105%]'  src={productImage} loading="lazy" alt={name || "Product"} />
      </div>
