...
const Product = () => {
  ...
  const fetchProductData = () => {
    ...
    if (item) {
      setProductData(item);
      setImage(item.images[0]); // first image as default
    }
  };
  ...
  return productData ? (
    <div className="border-t-2 transition-opacity ease-in duration-500 opacity-100 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
