...
import tend1 from "../assets/admin_assets/tend1.avif";
import tend2 from "../assets/admin_assets/tend2.jpg";
import tend3 from "../assets/admin_assets/tend3.jpg";
import tend4 from "../assets/admin_assets/tend4.jpg";
import tend5 from "../assets/admin_assets/tend5.jpg";

import Navbar from "./Navbar";

const team = [
  { name: "Ava Sinclair", role: "Creative Director", img: tend2 },
  { name: "Koma Sinclair", role: "Diva Director", img: tend3 },
  { name: "Shubham Sinclair", role: "Kalwa Director", img: tend4 },
  { name: "Kunal Sinclair", role: "Kopar Director", img: tend5 },
  { name: "Extra Slide", role: "Special", img: tend1 },
];

const bgColors = [
  { start: "#ffffff", end: "#ffffff" },
  { start: "#8e908a", end: "#8e908a" },
  { start: "#ffffff", end: "#ffffff" },
  { start: "#c4bca9", end: "#c4bca9" },
];
...
export default function Heropage() {
  ...
  useEffect(() => {
    ...
    const colors = bgColors[(currentSlide - 1) % bgColors.length];

    layer.style.background = colors.start;
    wipe.style.background = colors.end;
    ...
    gsap.to(wipe, {
      ...
      ease: "power2.out",
      onComplete: () => {
        layer.style.background = colors.end;
        gsap.set(wipe, { y: "100%" });
      },
    });
  }, [currentSlide]);
  ...
  return (
    <div
      className="main-wrapper relative text-center w-full min-h-screen overflow-hidden"
    ...
    >
      ...
      <div
        ref={heroRef}
        className="relative w-full h-[950px] md:h-screen overflow-hidden"
      >
        ...
        {team.map((_, i) => (
          ...
          >
            <p className="marquee-text text-[170px] mt-[65px] md:text-[200px] font-bold uppercase opacity-10 tracking-tight text-black">
              SHOP-SMART SHOP-SMART SHOP-SMART SHOP-SMART SHOP-SMART
            </p>

        {/* Center Image */}
        <div className="absolute inset-0 flex justify-center z-20">
          <div className="relative w-[360px] md:w-[560px] h-[380px] md:h-[540px] rounded-2xl shadow-2xl overflow-hidden bg-black">
            <img
        ...
        {/* Info */}
        <div className="absolute bottom-28 left-6 md:left-10 z-40 text-left">
